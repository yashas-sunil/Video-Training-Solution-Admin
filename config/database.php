...
return [
   ...
   'connections' => [
    ...
    'stream_db' => [
        'driver' => 'mysql',
        'host' => env('STREAM_DB_HOST', '127.0.0.1'),
        'port' => env('STREAM_DB_PORT', '3306'),
        'database' => env('STREAM_DB_DATABASE', 'forge'),
        'username' => env('STREAM_DB_USERNAME', 'forge'),
        'password' => env('STREAM_DB_PASSWORD', ''),
        'unix_socket' => env('STREAM_DB_SOCKET', ''),
        'charset' => 'utf8mb4',
        'collation' => 'utf8mb4_unicode_ci',
        'prefix' => '',
        'prefix_indexes' => true,
