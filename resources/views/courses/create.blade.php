            ...
            <div class="card custom-card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('scorm.upload') }}" enctype="multipart/form-data" id="uploadForm">
                        ...
                        <div class="mb-4">
                            <label for="watch_time" class="form-label">⏱ Total Watch Time (in minutes)</label>
                            <input type="number" name="watch_time" id="watch_time" class="form-control" placeholder="e.g. 90" min="1" required>
                        </div>

                        <div class="mb-4">
                            <label for="view_limit_option" class="form-label">👁 Validity (View Limit)</label>
                            <select name="view_limit_option" id="view_limit_option" class="form-control" required onchange="toggleCustomViewLimit()">
                        ...
                        <div class="mb-4" id="customViewLimitDiv" style="display: none;">
                            ...
                            <input type="number" name="view_limit" id="view_limit" class="form-control" placeholder="e.g. 10" min="1">
                        </div>
